        ...
        <ul class="swiper-wrapper">
            ...
            ?>
                <li class="swiper-slide">
                    <div class="bg_wrap"><img src="<?= $mainSlideData['thumbnail']['url'] ?>"></div>
                    <div class="text_wrap">
        ...
        <script>
            var mainBlogSwiper = new Swiper(".mainBlogSwiper", {
                pagination: {
                    ...
                    type: 'custom', // 페이지네이션 타입을 custom으로 설정
                    renderCustom: function(swiper, current, total) {
                        ...
                        if (current < adjustedTotal) {
                            return '<span>' + numFormat(current) + '</span>' + '<span class="divider"></span>' + '<span class="total">' + numFormat(adjustedTotal - 1) + '</span>'; // 현재 슬라이드 번호와 총 슬라이드 수를 표시
                        } else {
                            return '<span>' + numFormat(current - 1) + '</span>' + '<span class="divider"></span>' + '<span class="total">' + numFormat(adjustedTotal - 1) + '</span>';
                        }
                    }
                },
                speed: 700,
                ...
                on: {
                    slideChangeTransitionEnd: function() {
                        if (this.slides[this.activeIndex].classList.contains('empty')) {
