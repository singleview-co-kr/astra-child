...
if ( ! defined( 'ASTRA_CHILD_CACHE_PATH' ) ) {
	$a_path = explode( DIRECTORY_SEPARATOR, get_stylesheet_directory() );
	define( 'ASTRA_CHILD_CACHE_PATH', end( $a_path ) . DIRECTORY_SEPARATOR . 'cache' );
}
...
class CacheFileDisk {
	...
	public function set_storage_label( $s_storage_name = 'search' ) {
		$this->_s_cache_dir = wp_get_upload_dir()['basedir'] . DIRECTORY_SEPARATOR . ASTRA_CHILD_CACHE_PATH . DIRECTORY_SEPARATOR . $s_storage_name;
